...
public class EglHelper {
    ...
    public void initEgl(Surface surface, EGLContext eglContext) {
        ...
        mEglConfig = chooseConfig(mEgl, mEglDisplay, configs);
        if (mEglConfig == null) {
        ...
        if (eglContext == null) {
            mEglContext = mEgl.eglCreateContext(mEglDisplay, mEglConfig, EGL10.EGL_NO_CONTEXT, contextAttr);
        } else {
            mEglContext = mEgl.eglCreateContext(mEglDisplay, mEglConfig, eglContext, contextAttr);
        }
